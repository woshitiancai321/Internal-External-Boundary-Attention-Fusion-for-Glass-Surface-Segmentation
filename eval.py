...
from datasets import MSD, Trans10k, GDD, HSO ,GSD,PMD, GSDS
...
def setup_loader():
    ...
    if args.dataset == 'Trans10k' or args.dataset == 'MSD' or args.dataset == 'GDD' or args.dataset == 'HSO'or args.dataset == 'GSD'or args.dataset == 'PMD' or args.dataset == 'GSDS' :
        val_joint_transform_list = [joint_transforms.Resize(args.resize_scale)]
    ...
    if args.dataset == 'MSD':
        ...
        test_set = args.dataset_cls.HSODateset(args.mode, args.split,
                                               joint_transform_list=val_joint_transform_list,
                                               transform=val_input_transform,
                                               target_transform=target_transform)
        ...
        test_set = args.dataset_cls.GSDDateset(args.mode, args.split,
                                               ...
                                               transform=val_input_transform,
                                               target_transform=target_transform)
    elif args.dataset == 'PMD':
        args.dataset_cls = PMD
        test_set = args.dataset_cls.PMDDateset(args.mode, args.split,
                                               joint_transform_list=val_joint_transform_list,
                                               transform=val_input_transform,
                                               target_transform=target_transform)          
    elif args.dataset == 'GSDS':
        args.dataset_cls = GSDS
        test_set = args.dataset_cls.GSDSDateset(args.mode, args.split,
                                               joint_transform_list=val_joint_transform_list,
                                               transform=val_input_transform,
                                               target_transform=target_transform)                                     
    else:
